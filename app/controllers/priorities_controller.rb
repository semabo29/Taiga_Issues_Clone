class PrioritiesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @priority.update(priority_params)
        format.html { redirect_to @priority, notice: "Priority was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to priorities_path, notice: "Priority was successfully destroyed.", status: :see_other }
